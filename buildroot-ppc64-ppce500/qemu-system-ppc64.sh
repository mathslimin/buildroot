...
DEFAULT_KERNEL=${DEFAULT_IMAGES_DIR:-.}/uImage
...
if [[ "${ARG_DRIVER:-n}" != "n" ]]; then
	QEMU_OPT_driver="-drive file=${ARG_DRIVER},if=virtio,format=raw"
...
QEMU_OPT_machine="-machine ppce500"
QEMU_OPT_cpu="-cpu e5500"
#QEMU_OPT_smp="-smp 1"
QEMU_OPT_m="-m 1024M"
